...
public class PE04 {
    // Estat de les llums per habitació 
    ...
    public static void main(String[] args) {
        ...
        // Bucle principal que mostra el menú temàtic i delega a sub-menús
        do {
            ...
            switch (cmenu) {
                ...
                case "musica":
                    // Menú de música: seleccionar habitació i reproduir
                    musica = true;
                    do {
                ...
                case "roomba":
                    // Menú de Roomba: comprovar estat, netejar i programar temps
                ...
                case "temperatura":
                    // Menú de temperatura: modificar per habitació o global
    ...
    // Encen/Apaga una habitació concreta segons 'a' i estat 'b' (on/off) 
    public static void unallum(String a, String b) {
        ...
        if (a.equalsIgnoreCase("Cuina") || a.equalsIgnoreCase("wc") || a.equalsIgnoreCase("Habitacio1")
                || a.equalsIgnoreCase("Habitacio2") || a.equalsIgnoreCase("Menjador") || a.equalsIgnoreCase("Habitacio3")) {
            if (b.equals("on")) {
                b = "encesos";
            }
            if (b.equals("off")) {
    ...
    // Encen o apaga totes les llums segons 'status' (on/off) 
    ...
    // Mostra l'estat de totes les llums 
    ...
    // Demana a l'usuari quina habitació vol utilitzar i valida l'input 
    public static void chooseRoom() {
        ...
        do {
            ...
            if (triarhabitacio.equalsIgnoreCase("Cuina") || triarhabitacio.equalsIgnoreCase("Menjador")
                    || triarhabitacio.equalsIgnoreCase("Habitacio1") || triarhabitacio.equalsIgnoreCase("Habitacio2")
                    || triarhabitacio.equalsIgnoreCase("Habitacio3") || triarhabitacio.equalsIgnoreCase("wc")
                    || triarhabitacio.equalsIgnoreCase("exit")) {
                menuChooseRoom = true;
            } else {
    ...
    // Llegeix l'element a reproduir en el menú de música i mostra missatge 
    ...
    // Defineix el nombre de rajoles segons la habitació i marca com a neta 
    ...
    // Simula el recorregut per rajoles i mostra el procés 
    ...
    // Mostra si la habitació està neta o bruta
    ...
    // Assigna la cadena net/brut segons el boolean passat
    ...
    // Mostra passos i resultat quan es modifica la temperatura 
    ...
    // Llegeix hores i minuts per programar la Roomba i simula el recompte 
